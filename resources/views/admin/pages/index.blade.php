...
@section('css')
 <!-- chartist CSS -->
    <link href="{!!asset('backend_assets/')!!}/plugins/chartist-js/dist/chartist.min.css" rel="stylesheet">
    <link href="{!!asset('backend_assets/')!!}/plugins/chartist-js/dist/chartist-init.css" rel="stylesheet">
    <link href="{!!asset('backend_assets/')!!}/plugins/chartist-plugin-tooltip-master/dist/chartist-plugin-tooltip.css" rel="stylesheet">
    <link href="{!!asset('backend_assets/')!!}/plugins/css-chart/css-chart.css" rel="stylesheet">
    <script>
                            ...
                            <div class="table-responsive m-t-40">
                                <table class="table stylish-table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="active">
                                            <td><span class="round"><img src="{!!asset('backend_assets/')!!}/images/users/2.jpg" alt="user" width="50" /></span></td>
                                            <td>
                    ...
                    <div class="card">
                        ...
                        <div class="comment-widgets">
                            ...
                            <div class="d-flex flex-row comment-row">
                                <div class="p-2"><span class="round"><img src="{!!asset('backend_assets/')!!}/images/users/1.jpg" alt="user" width="50"></span></div>
                            ...
                            <div class="d-flex flex-row comment-row active">
                                <div class="p-2"><span class="round"><img src="{!!asset('backend_assets/')!!}/images/users/2.jpg" alt="user" width="50"></span></div>
                            ...
                            <!-- Comment Row -->
                            <div class="d-flex flex-row comment-row">
                                <div class="p-2"><span class="round"><img src="{!!asset('backend_assets/')!!}/images/users/3.jpg" alt="user" width="50"></span></div>
                                <div class="comment-text w-100">
                            ...
                            <!-- Comment Row -->
                            <div class="d-flex flex-row comment-row">
                                <div class="p-2"><span class="round"><img src="{!!asset('backend_assets/')!!}/images/users/4.jpg" alt="user" width="50"></span></div>
                                <div class="comment-text w-100">
                                    <h5>James Anderson</h5>
                                    <p class="m-b-5">Lorem Ipsum is simply dummy text of the printing and type setting industry. Lorem Ipsum has beenorem Ipsum is simply dummy text of the printing and type setting industry..</p>
                                    <div class="comment-footer">
                            ...
                            <div class="to-do-widget m-t-20">
                                ...
                                <ul class="list-task todo-list list-group m-b-0" data-role="tasklist">
                                    <li class="list-group-item" data-role="task">
                                        ...
                                        <ul class="assignedto">
                                            <li><img src="{!!asset('backend_assets/')!!}/images/users/1.jpg" alt="user" data-toggle="tooltip" data-placement="top" title="" data-original-title="Steave"></li>
                                            <li><img src="{!!asset('backend_assets/')!!}/images/users/2.jpg" alt="user" data-toggle="tooltip" data-placement="top" title="" data-original-title="Jessica"></li>
                                            <li><img src="{!!asset('backend_assets/')!!}/images/users/3.jpg" alt="user" data-toggle="tooltip" data-placement="top" title="" data-original-title="Priyanka"></li>
                                            <li><img src="{!!asset('backend_assets/')!!}/images/users/4.jpg" alt="user" data-toggle="tooltip" data-placement="top" title="" data-original-title="Selina"></li>
                                        </ul>
                                    </li>
                                    <li class="list-group-item" data-role="task">
                                        <div class="checkbox checkbox-info">
                                    ...
                                    <li class="list-group-item" data-role="task">
                                        ...
                                        <ul class="assignedto">
                                            <li><img src="{!!asset('backend_assets/')!!}/images/users/1.jpg" alt="user" data-toggle="tooltip" data-placement="top" title="" data-original-title="Assign to Steave"></li>
                                            <li><img src="{!!asset('backend_assets/')!!}/images/users/2.jpg" alt="user" data-toggle="tooltip" data-placement="top" title="" data-original-title="Assign to Jessica"></li>
                                            <li><img src="{!!asset('backend_assets/')!!}/images/users/4.jpg" alt="user" data-toggle="tooltip" data-placement="top" title="" data-original-title="Assign to Selina"></li>
                                        </ul>
                                    </li>
                                </ul>
                            </div>
    ...
    <!-- ============================================================== -->
    <!-- chartist chart -->
    <script src="{!!asset('backend_assets/')!!}/plugins/chartist-js/dist/chartist.min.js"></script>
    <script src="{!!asset('backend_assets/')!!}/plugins/chartist-plugin-tooltip-master/dist/chartist-plugin-tooltip.min.js"></script>
    <!-- Chart JS -->
    <script src="{!!asset('backend_assets/')!!}/plugins/echarts/echarts-all.js"></script>
    <script src="{!!asset('backend_assets/')!!}/js/dashboard5.js"></script>
    @stop
