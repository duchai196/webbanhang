...
@stop
@section('links')
    <a href="{!! route('brand.create') !!}" class="btn pull-right hidden-sm-down btn-success"> <i class="mdi mdi-plus-circle"></i> Thêm thương hiệu</a>
@stop
@section('content')
    <div class="row">
        <div class="col-md-12">
                            ...
                            @foreach($listBrand as $item)
                                <tr>
                                    ...
                                    <td style="text-align: center">
                                        <a href="{{route('brand.edit',$item->id)}}"><i class="mdi mdi-lead-pencil"></i></a>
