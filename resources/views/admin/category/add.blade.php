                        ...
                        <div class="col-sm-12 col-xs-12">
                            ...
                            <form action="{!! route('category.store') !!}" method="POST">
                                ...
                                <div class="form-check">
                                    ...
                                    <div>
                                        <label class="custom-control custom-radio">
                                            <input id="radio1" name="category_type" value="post" type="radio"
                                        ...
                                        <label class="custom-control custom-radio">
                                            <input id="radio2" name="category_type" type="radio" value="product"
                                                   class="custom-control-input">
                                            <span class="custom-control-indicator"></span>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="name" placeholder="eg: Cầu lông"
                                           name="name">
                                </div>
                                <div class="form-group">
                                ...
                                <button type="button" class="btn btn-inverse waves-effect waves-light"><a
                                            href="{{URL::previous()}}" class="text-white">Hủy</a></button>
                                <button type="submit" class="btn btn-success waves-effect waves-light m-r-10">Thêm danh
                                    mục
                                </button>
                            </form>
                        </div>
