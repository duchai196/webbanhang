...
@stop
@section('links')
    <a href="{!! route('post.create') !!}" class="btn pull-right hidden-sm-down btn-success"> <i class="mdi mdi-plus-circle"></i> Thêm tin tức</a>
@stop
                            ...
                            @foreach($listPost as $item)
                                <tr>
                                    ...
                                    <td style="text-align: center">
                                        <a href="{{route('post.edit',$item->id)}}"><i class="mdi mdi-lead-pencil"></i></a>
                ...
                if(confirm('Bạn có chắc muốn xóa?')){
                    ...
                    $.ajax({
                        ...
                        .done(function(data){
                            ...
                            swal("Xóa thành công", "Tin tức đã được xóa :)", "success");
                        })
                        .fail(function() {
                            swal("Đã xảy ra lỗi", "Tin tức chưa được xóa :)", "error");
                        });
                }
            });
        });
