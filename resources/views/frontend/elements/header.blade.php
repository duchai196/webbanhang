			...
			<div class="row">
				...
				<div class="col-sm-8">
					<div class="shop-menu pull-right">
						<ul class="nav navbar-nav">
							@if(Auth::check())
								<li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-user"></i> Hello! {!! Auth::user()->name !!} <span class="caret"></span></a>
									<ul class="dropdown-menu">
										@if(Auth::user()->role==1)
											<li><a href="{{ route('index')}}"><i class="fa fa-cogs" aria-hidden="true"></i> Quản trị website</a></li>
										@endif
										<li><a href="{{ route('logout')}}"> <i class="fa fa-sign-out" aria-hidden="true"></i> Đăng xuất</a></li>
										<li><a href="javascript:void(0)"> <i class="fa fa-address-card" aria-hidden="true"></i> Thông tin tài khoản</a></li>

									</ul>
								</li>
							@else
								<li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-user"></i> Tài khoản <span class="caret"></span></a>
									<ul class="dropdown-menu">
							...
							<li class="cart-menu"><a href="{!! route('cart') !!}"><i class="fa fa-shopping-cart"></i> Giỏ hàng</a>
